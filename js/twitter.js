...
function consolidateJSON() {
  console.log("consolidateJSON and search text is : " + searchText);
  $.ajax({
        type: "POST",
        url: "ajax_twitter.php",
        data: {functionName: 'consolidateJSON', searchText: searchText},
...
function gettwitterjson() {
  if (!timeLimitReached()) {
    ...
    $.ajax({
      type: "POST",
      url: "ajax_twitter.php",
      data: {functionName: 'getTwitterJSON', searchText: searchText},
      success: function (result) {
        feeds = result.data.statuses; //search returns an array of statuses
        var feedHTML = '';
